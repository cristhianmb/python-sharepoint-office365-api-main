...
#H1
def aplicar_formula66_1(row, df604):
    resultado = df604.loc[row.name, 'Y1'] * 0.70
    return resultado 


#H2
def aplicar_formula67(row, df605):
    resultado = df605.loc[row.name, 'Y2'] * 0.70
    return resultado 


#H3
def aplicar_formula68(row, df606):
...
def aplicar_formula_2(row, df606_1, df500, df501, df502, df503, df504):
    resultado = (
...
def aplicar_formula_5_2(row, df606_1, df505, df609, df506, df610, df507, df611, df508, df611_1, df509, df612):
    resultado = (
...
def aplicar_formula_22(row, df606_1, df504_2):
    resultado = (
...
def aplicar_formula_10_2(row, df606_1, df510, df511):
    resultado = (
...
def aplicar_formula_11(row, df606_1, df500_22, df509_2):
    resultado = (
        df606_1.loc[row.name, 'H1'] * (0.72 +
...
def aplicar_formula_222(row, df607, df512, df513, df513_1):
    resultado = (
...
def aplicar_formula_33(row, df514, df608):
    resultado = (
...
def aplicar_formula_44(row, df613, df515, df516, df613_2, df613_3, df517, df518, df613_4):
    resultado = 0.10 * ( 
...
def aplicar_formula46(row, df613, df613_4, df519, df614_1, df614, df520, df615, df521, df616, df522, df617, df523, df618, df524):
...
def aplicar_formula_45(row, df500_44, df613, df613_4, df500_466):
    # Calcular la primera parte de la fórmula
...
def aplicar_formula_66(row, df526, df527):
    resultado = 0.5 * (
...
def aplicar_formula_73(row, df613, df530, df613_2, df531, df613_3, df532, df613_4, df533):
    resultado = 0.25 * (
        df613.loc[row.name, 'b-Sucursales'] *
...
def aplicar_formula_711(row, df528_70, df528_72, df500_73, df500_74):
    resultado = (
...
def aplicar_formula_111(row, df500_11, df606_1, df500_222, df607, df500_33, df608, df500_45, df525_11, df500_66):
    resultado = (
...
# Calificación (0-10)
def aplicar_formula801_A(row, df800_A, df500_111):
...
# Punto extra (0-1)
def aplicar_formula802_A(row, df500_700, df500_111):
...
def aplicar_formula803_A(row, df801_A, df802_A):
...
def logica_codigo(ruta_origen, ruta_destino):
    ...
    df603['Ingresos_IEB'] = df603.apply(lambda row: aplicar_formula63(row, df600, df601, df602), axis=1)
    # Reemplazar la columna 'Ingresos_IEB' por 'Calificación (0-10)'
    #df603['Ingresos_IEB'] = df603['Calificación (0-10)']
    ...
    df604['Y1'] = df604.apply(lambda row: aplicar_formula64(row, df600, df603), axis=1)
    ...
    #Y2
    df605 = df_DB.copy()
    df605['Y2'] = df605.apply(lambda row: aplicar_formula65(row, df601, df603), axis=1)
    ...
    df606['Y3'] = df606.apply(lambda row: aplicar_formula66(row, df602, df603), axis=1)
    ...
    df606_1['H1'] = df606_1.apply(lambda row: aplicar_formula66_1(row, df604), axis=1)
    ...
    df607['H2'] = df607.apply(lambda row: aplicar_formula67(row, df605), axis=1)
    ...
    df608['H3'] = df608.apply(lambda row: aplicar_formula68(row, df606), axis=1)
    ...
    df500_2['1.1.1'] = df500_2.apply(lambda row: aplicar_formula_2(row, df606_1, df500, df501, df502, df503, df504), axis=1)
    ...
    df504_2['1.1.2'] = df504_2.apply(lambda row: aplicar_formula_5_2(row, df606_1, df505, df609, df506, df610, df507, df611, df508, df611_1, df509, df612), axis=1)
    ...
    # Redondear utilizando leyes de aproximación
    df500_22['1.1'] = df500_22.apply(lambda row: aplicar_formula_5_2(row, df606_1, df504_2), axis=1)
    ...
    #df801_A ['Calificación (0-10)'] = df801_A.apply(lambda row: aplicar_formula803_A(row, df801_A, df802_A), axis=1)
    
    
    
    
    # Crear copia del DataFrame aplicar_formula801_A(row, df800_A, df500_111):
    df801_A = df_DB.copy()
    # Aplicar la función a cada fila
    df801_A['Calificación (0-10)'] = df801_A.apply(lambda row: aplicar_formula801_A(row, df800_A, df500_111), axis=1)
    ...
    df802_A['Calificación (0-10)'] = df802_A.apply(lambda row: aplicar_formula802_A(row, df500_700, df500_111), axis=1)
    ...
    # Calificación final (0-10)
    df803_A = df_DB.copy()
    df803_A['Calificación (0-10)'] = df803_A.apply(lambda row: aplicar_formula803_A(row, df801_A, df802_A), axis=1)
