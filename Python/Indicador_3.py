...
def Indicador_3(df_hoja4_1, df_hoja2):
    
    df_combinado3 = pd.merge(df_hoja4_1, df_hoja2[['claveinstitucion', 'nombreinstitucion']], how='left', left_on='institucion', right_on='claveinstitucion')
